class AppConfig {
  ...
  static const buildCode = int.fromEnvironment('APP_BUILD_CODE', defaultValue: 5);
  static const versionName = String.fromEnvironment('APP_VERSION_NAME', defaultValue: '0.3.2');
